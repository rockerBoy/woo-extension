<div class="form-field form-required term-additional-field-wrap">
    <div class="additional_field_wrap">
        ...
        <input name="additional_field[]" class="additional_field" type="text" value="" size="40" aria-required="true">
        <button class="remove_field" type="button"><svg viewBox="0 0 24 24"><path d="M12,2C6.486,2,2,6.486,2,12s4.486,10,10,10s10-4.486,10-10S17.514,2,12,2z M16.207,14.793l-1.414,1.414L12,13.414 l-2.793,2.793l-1.414-1.414L10.586,12L7.793,9.207l1.414-1.414L12,10.586l2.793-2.793l1.414,1.414L13.414,12L16.207,14.793z"></path></svg></button>
    </div>
